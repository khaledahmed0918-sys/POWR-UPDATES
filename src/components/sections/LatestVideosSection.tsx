        ...
        >
          {[...videos, ...videos].map((video, index) => (
            <div 
              ...
              dir="rtl"
            >
              <Card className="flex flex-col h-full border-red-500/20 hover:border-red-400/50 hover:shadow-[0_10px_40px_-10px_rgba(239,68,68,0.3)] transition-all duration-300 p-0 overflow-hidden glass-card">
                <div className="relative aspect-video overflow-hidden" onClick={() => setPopupImage(video.thumbnail)}>
                  ...
                  />
                  <div className="absolute inset-0 flex items-center justify-center bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity text-red-400">
                    <FaPlay size={48} />
                  </div>
                </div>
